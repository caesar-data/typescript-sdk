...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: Caesar, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
...
export class Pagination<Item> extends AbstractPage<Item> implements PaginationResponse<Item> {
  ...
  override hasNextPage(): boolean {
    if (this.pagination?.has_next === false) {
      return false;
    }
